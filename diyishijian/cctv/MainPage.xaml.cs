...
namespace cctv
{
    ...
    {
        // 构造函数
        string lmstr = "http://cctv.cntv.cn/diyishijian2011/01/";
        ...
        public MainPage()
        {
          ...
          //  pclient.DownloadStringAsync(new Uri(str, UriKind.RelativeOrAbsolute));
            ...
            todayclient.OpenReadAsync(new Uri(requesturl, UriKind.RelativeOrAbsolute));
            todayclient.OpenReadCompleted += pclient_OpenReadCompleted;
            ...
            if (ji > 3)
            {
                ...
                adView.ApplicationKey = "3464e35f73a0a92ac33eff00be479175";
